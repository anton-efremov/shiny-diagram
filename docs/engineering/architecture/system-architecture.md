...
| Producer | Input data | Current calculation | Implementation |
|---|---|---|---|
| Editor status / interaction hook | Generate button, React Flow drag-stop, color input event, or placement-overlay draw | Emits `generate`, aggregate `class.move`, `style.setClassProperty`, or `class.add` | [EditorStatus.tsx](../../../webview/src/shinyView/EditorView/EditorStatus/EditorStatus.tsx), [useClassBoxNodeInteractions.ts](../../../webview/src/shinyView/EditorView/ClassDiagram/useClassBoxNodeInteractions.ts), [useStylePaneInteractions.ts](../../../webview/src/shinyView/EditorView/StylePane/useStylePaneInteractions.ts), [usePlacementOverlayInteractions.ts](../../../webview/src/shinyView/EditorView/ClassDiagram/PlacementOverlay/usePlacementOverlayInteractions.ts) |
