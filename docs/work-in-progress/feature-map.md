...
|  | View toggle: Autorender | Click | Editor view active | Default | Switches active view to Autorender. | Renders current source through Mermaid; Shiny annotations are ignored as comments; EditPane and ToolPane are hidden; selection is remembered but inactive; no source edit. |
...
|  | Mermaid element | Click | Diagram rendered | Default | No element selection in Shiny. | EditPane is not shown; no source edit. |
...
|  |  | Click | An element is selected; no active tool | Default | Selection clears. | EditPane clears; no source edit. |
...
|  |  | Click | Class-like placement tool active | Crosshair | Creates the selected class-like element centered at click position. | Adds semantic class declaration plus @spatial; selects the new element; EditPane shows its style. |
...
|  |  | Click | No element selected | Default | Class becomes selected. | EditPane shows class controls; resize handles and relationship anchors appear. |
|  |  | Click | Another element selected | Default | Class becomes selected. | Previous selection clears; EditPane updates to class controls. |
...
|  |  | Click | Class not selected | I-beam | Class becomes selected and class-name inline editor opens. | EditPane shows class controls; no source edit until commit. |
...
|  |  | Commit inline edit | Value is valid | Default | Stereotype is updated. | Updates the class body stereotype line in source; EditPane reflects new stereotype. |
...
|  |  | Click | Class not selected | I-beam | Class becomes selected and member inline editor opens for that row. | EditPane shows class controls; no source edit until commit. |
...
|  |  | Click | Any other element selected or none selected | Default | Class becomes selected. | EditPane shows class controls; resize handles and relationship anchors appear. |
...
|  |  | Click | Class not selected | Default | Class becomes selected. | EditPane shows class controls; no resize unless pointer moves past drag threshold. |
...
|  |  | Click | No element selected | Default | Relationship becomes selected. | EditPane shows relationship semantic controls: type, label, delete. Visual stroke controls stay hidden until edge styling syntax is defined. |
|  |  | Click | Another element selected | Default | Relationship becomes selected. | Previous selection clears; EditPane switches to relationship controls. |
...
|  |  | Click | Any selection state | Default | Relationship becomes selected. | EditPane shows relationship semantic controls. |
...
|  |  | Click | Relationship not selected | Default | Relationship becomes selected. | EditPane shows relationship controls; no text edit yet to avoid accidental edits. |
...
|  |  | Click | No element selected | Default | Namespace becomes selected. | EditPane shows namespace style controls. |
|  |  | Click | Another element selected | Default | Namespace becomes selected. | Previous selection clears; EditPane updates to namespace controls. |
...
|  |  | Click | Any selection state | Default | Namespace becomes selected. | EditPane shows namespace style controls. |
...
|  |  | Click | Namespace not selected | Default | Namespace becomes selected. | No text edit yet; EditPane shows namespace controls. |
...
| EditPane | Pane body | Render | Nothing selected | Default | Shows empty state or disabled controls. | No source edit. |
...
|  |  | Keydown | Element selected; no transient operation | — | Clears selection. | EditPane clears; no source edit. |
|  | Delete or Backspace | Keydown | Class selected; not editing text | — | Invokes class delete behavior. | Same as EditPane Delete element for class. |
|  |  | Keydown | Relationship selected; not editing text | — | Invokes relationship delete behavior. | Same as EditPane Delete element for relationship. |
|  |  | Keydown | Namespace selected; not editing text | — | Invokes namespace delete behavior. | Same as EditPane Delete element for namespace. |
...
|  |  | Change detected | Selected element deleted externally | Default | Selection clears after refresh. | EditPane clears. |
...
| Resize class | Update `w` and `h` in `%% @spatial:<ClassId>` | Resize drag-stop, Fit to content, or valid edit-pane size action | One undo step per completed resize |
...
| Rename class | Rewrite class declaration, relationship references, style application, and `@spatial` id | Inline/edit-pane commit | One undo step |
...
| Edit relationship label/type | Rewrite relationship line | Inline/edit-pane commit | One undo step |
