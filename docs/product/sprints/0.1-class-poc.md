...
- User changes fill color from edit pane.
...
- Elements:
  ...
  - Note/comment object (`note "..."`, `note for X "..."`):
    - no edit-pane controls defined yet
...
- Elements:
  ...
  - Outer frame:
    ...
    - on click: select box, show resize handles, populate edit pane. (ENABLED)
...
- Elements:
  ...
  - Edge line:
    ...
    - on click: select edge, populate edit pane. (ENABLED)
...
- Click on class box border:
  - Icon: arrow;
  - Behavior: select box, show resize handles, show edit pane for class box. (ENABLED)
...
- Click on relationship edge:
  - Icon: arrow;
  - Behavior: select edge, populate edit pane. (ENABLED)
...
- Click on note/comment object:
  - Icon: arrow;
  - Behavior: select note, populate edit pane. (DISABLED)
...
- Click on namespace/group:
  - Icon: arrow;
  - Behavior: select namespace, populate edit pane. (DISABLED)
