...
export const RELATIONSHIP_EDGE_TEXT_MIN_WIDTH = 48;
export const RELATIONSHIP_EDGE_TEXT_CHARACTER_WIDTH = 7;
export const RELATIONSHIP_EDGE_TEXT_CANCEL_ALLOWANCE = 30;
...
export const NAMESPACE_NAME_AREA_HEIGHT = 28;
...
export const NAMESPACE_DEFAULT_FILL = "rgba(166, 166, 166, 0.1)";
export const NAMESPACE_DEFAULT_STROKE = "#a6a6a6";
