...
export const NAMESPACE_STYLE_PANE_SECTION_PADDING = 12;
export const NAMESPACE_STYLE_PANE_SECTION_GAP = 10;
export const NAMESPACE_STYLE_PANE_FIELD_GAP = 4;
export const NAMESPACE_STYLE_PANE_CONTROL_GAP = 8;
export const NAMESPACE_STYLE_PANE_INPUT_PADDING_Y = 6;
export const NAMESPACE_STYLE_PANE_INPUT_PADDING_X = 8;
export const NAMESPACE_STYLE_PANE_FONT_SIZE = 12;
export const NAMESPACE_STYLE_PANE_INPUT_RADIUS = 6;
export const NAMESPACE_STYLE_PANE_COLOR_PICKER_FALLBACK = "#ffffff";
export const NAMESPACE_STYLE_PANE_INPUT_BORDER_WIDTH = 1;
export const NAMESPACE_STYLE_PANE_INPUT_MIN_WIDTH = 0;
