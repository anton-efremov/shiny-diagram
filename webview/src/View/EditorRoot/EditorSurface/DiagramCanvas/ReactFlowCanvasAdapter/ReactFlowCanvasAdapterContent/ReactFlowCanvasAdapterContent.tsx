...
export default function ReactFlowCanvasAdapterContent({
  view,
  selectionState,
  nodePlacementState,
  classBoxPlacementState,
  ...
  onConnectAborted,
  onPlacementComplete,
}: ReactFlowCanvasAdapterContentProps): ReactElement {
