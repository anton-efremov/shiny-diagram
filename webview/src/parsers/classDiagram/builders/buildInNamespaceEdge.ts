/**
 * @fileoverview Builds InNamespaceEdge values from namespace child tokens.
 */

import type { InNamespaceEdge } from "../../../models/classDiagram/diagramTreeModel";
import { toClassId, toNamespaceId } from "../../../models/classDiagram/primitives";
import type { ParseToken } from "../tokenizer";
import { toSourceLocation } from "./toSourceLocation";

/**
 * Builds namespace membership edges for direct classDeclaration children.
 */
